...
# 🔥 [NEW] ห้องสำหรับระบบ Dashboard (ใส่ ID ห้องจริง)
...
class MainShopView(discord.ui.View):
    ...
    # 🔥 แก้ไข: ปุ่มเช็คยอดเป็น Embed สีเขียวเล็กๆ (ตามรูปที่ต้องการ)
